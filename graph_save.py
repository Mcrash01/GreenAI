...
def show_map(graph_data, step=0, node_colors=None):
    ...
    formatted_labels = {key: f"production : {value['production'][step]}<br/> consumption : {round(value['consumption'][step])}" for key, value in data.items()}
